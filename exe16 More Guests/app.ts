...
invited_person.map((item)=>
console.log(`Dear ${item},you are invited for tomorrow's dinner and i found a bigger dinner table.`))

// Add one new guest to the beginning of your array.

let begining_guest:string="Haizal"
